 ...
 /**
  ...
  function getTrainingScheduleDetails() {
    try {
      ...
      $scope.trainingScheduleDetail = {'id' : 1, 'trainingcenter' : {name : 'Pune training center'},
      'trainingcourse' : {name : 'MotorCycle Basic', 'validFrom' : '10/03/2017'}, 'state' : {'name' : 'Maharashtra'},
      'startDate' : '22/04/2017', 'endDate' : '25/04/2017', 'trainerName' : 'Mr. Arun Jadhav',
      'description' : 'All Courses conducted at this training center' };
    } catch(err) {
